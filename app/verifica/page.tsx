      ...
      <div className="shell" style={{ maxWidth: 720 }}>
        ...
        <form action="/verifica" method="get" className="panel form" style={{ marginTop: 24 }}>
          <label className="full">
            Codice certificato
            <input name="code" placeholder="Es. VSC-A8F4D91B2E" required autoCapitalize="characters" autoComplete="off" spellCheck={false} />
          </label>
          <button className="button full" type="submit">Verifica certificato</button>
        </form>
        <p style={{ marginTop: 16, opacity: 0.7, fontSize: 14 }}>Puoi digitare il codice manualmente oppure aprire il QR presente sul certificato.</p>
