...
type Booking = {
  ...
  certificate?: { id: string; public_code: string } | null;
};
                ...
                {filteredBookings.map((booking) => {
                  ...
                  return <article className={`workshop-booking ${styles.workshopBooking}`} key={booking.id}>
                    ...
                    <div className="workshop-booking-actions">
                      ...
                      {booking.status === "completed" && booking.certificate?.id && <Link className="button" href={`/api/workshop/certificates/${encodeURIComponent(booking.certificate.id)}/pdf`}><Download size={17} /> PDF</Link>}
